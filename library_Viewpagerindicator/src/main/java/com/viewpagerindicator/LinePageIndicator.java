...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultSelectedColor = res.getColor(R.color.default_line_indicator_selected_color, null);
        final int defaultUnselectedColor = res.getColor(R.color.default_line_indicator_unselected_color, null);
