...
public class VideoActivity extends Activity implements
	...
	// // Log.d("video", file.exists() ? "OK" : "file is not found");
	...
	public void initVideoView() {
		...
		// Uri uri = Uri
		// .parse("http://123.150.52.227/0725695b00000000-1415769042-1960016430/data5/vkplx.video.qq.com/flv/74/164/a0015193bxf.p203.1.mp4");
		videoView.setVideoURI(uri);
	}
