...
public class DoubleDatePickerDialog extends AlertDialog implements OnClickListener, OnDateChangedListener {
    ...
    public DoubleDatePickerDialog(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear,
        ...
        View view = inflater.inflate(CPQApplication.VERSION == Constant.PHONE ? R.layout.date_picker_dialog : R.layout.date_picker_dialog_tv, null);
        setView(view);
        ...
        mDatePicker_start.setMaxDate(calendar.getTimeInMillis());
        mDatePicker_end.setMaxDate(calendar.getTimeInMillis());
     ...
     * @param theme    the theme to apply to this dialog
     * @param callBack How the parent is notified that the date is set.
     * @param start    Current start time
     * @param end      Current end time
     */
    public DoubleDatePickerDialog(Context context, int theme, OnDateSetListener callBack, CalendarUtil start, CalendarUtil end, boolean isDayVisible) {
        super(context, theme);
        ...
        mDatePicker_start = (DatePicker) view.findViewById(R.id.datePickerStart);
        mDatePicker_end = (DatePicker) view.findViewById(R.id.datePickerEnd);
        mDatePicker_start.init(start.getYear(), start.getMonth(), start.getDateOfMonth(), this);
        mDatePicker_end.init(end.getYear(), end.getMonth(), end.getDateOfMonth(), this);
        CalendarUtil calendarUtil = new CalendarUtil();
        CalendarUtil erCalendarUtio = new CalendarUtil();
        erCalendarUtio.set(2013, 0, 1);
        mDatePicker_start.setMinDate(erCalendarUtio.getTimeInMillis());
        mDatePicker_end.setMinDate(erCalendarUtio.getTimeInMillis());
        mDatePicker_start.setMaxDate(calendarUtil.getTimeInMillis());
        mDatePicker_end.setMaxDate(calendarUtil.getTimeInMillis());
        // updateTitle(year, monthOfYear, dayOfMonth);
